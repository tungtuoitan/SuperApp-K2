...
# Ta nên Refactor như thế nào? [id:710 order:3]
- FE trước , BE sau
- chia thành nhiều đợt, mỗi đợt 1 ý
- có gap giữa các đợt

# Mình nên đọc mấy Repo đây? vì sao? [id:711 order:4]
mình nên đọc 3 repo
...
# Tại sao mình lại chọn Repo bulletproof-react? [id:712 order:5]
- vì nó 34k star, cho nên uy tín

# Đọc Repo để làm gì? [id:713 order:6]
để phân tích và đánh giá, và áp dụng cái hay của nó vào SuperApp

# Tại sao phải chia refactor thành nhiều giai đoạn? và tại sao cần khoảng gap giữa chúng? [id:714 order:7]
vì sau mỗi đợt refactor, mình cần sử dụng để cảm nhận được lợi ích của nó, để đảm bảo k tốn công vô ích

# Nếu sourceCode mình đọc có vấn đề thì sao? [id:715 order:8]
...
# Thế nào là source code tốt? [id:716 order:9]
- dễ đọc
- dễ mở rộng
- dễ bảo trì

# Refactor SuperApp có nhanh không? vì sao? [id:717 order:10]
không nhanh,
