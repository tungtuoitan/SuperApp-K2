...
# Uỷ quyền và trao quyền có phải là 1 không? [id:2744 order:3]
có, chúng là 1.

# Phân biệt Authentication và authorization? [id:2745 order:4]
- authentication là xác thực, còn authorization là trao quyền
- E trước O
- xác thực xong thì mới trao quyền

# Token-based Authentication là gì? [id:2746 order:5]
- là xác thực dựa trên Token

# Authentication là gì? [id:2747 order:6]
