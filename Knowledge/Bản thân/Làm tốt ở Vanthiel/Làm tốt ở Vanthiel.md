...
<!--# Thế nào là làm task tốt? [id:3224 order:1]
...
<!--# mình cần comment những gì? [id:3225 order:2]
- progress
- lí do task làm lâu
- các feature, logic liên quan đến task -->

# lưu ý khi update thông tin trong task? [id:3226 order:3]
- thông tin phải realtime

# Khi nào thì nên hỏi b? [id:3227 order:4]
- khi đó là UI k đơn giản

<!--# b muốn gì? [id:3228 order:5]
...
# lưu ý gì khi hỏi b? [id:3229 order:6]
- chuẩn bị 3 option để ổng chọn

# tại sao nên ngồi kế b khi làm UI? [id:3230 order:7]
live coding làm task UI cho tiện

<!--# đặc điểm của b? [id:3231 order:8]
- ghét chỉnh sửa lặt vặt
- b đưa ra ý tưởng, requirement chung chung, dev phải tự demo output
- dev ít reschedule -->

<!--# thế nào là làm task chuyên nghiệp? [id:3232 order:9]
- no side effect
- deploy ít
- hỏi ngớ ngẩn
- demo output nếu cần
...
<!--# quy tắc làm task? [id:3233 order:10]
- demo output nếu requirement chưa rõ ràng
- -->

<!--# quy tắc làm việc [id:3234 order:11]
tự document để nắm hết được mọi logic, realtime -->

# làm tốt ở Vanthiel để làm gì? [id:3235 order:12]
