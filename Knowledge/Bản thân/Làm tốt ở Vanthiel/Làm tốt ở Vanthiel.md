...
<!--# Thế nào là làm task tốt? [id:1172 order:1]
...
<!--# mình cần comment những gì? [id:1173 order:2]
- progress
- lí do task làm lâu
- các feature, logic liên quan đến task -->

# lưu ý khi update thông tin trong task? [id:1174 order:3]
- thông tin phải realtime

# Khi nào thì nên hỏi b? [id:1175 order:4]
- khi đó là UI k đơn giản

<!--# b muốn gì? [id:1176 order:5]
- nắm thông tin real time
- dev dùng AI
- dev chỉ làm việc với Renel
- img trong cmt rõ ràng, trực quan
- làm việc chuyên nghiệp
- k được rảnh tay -->

# lưu ý gì khi hỏi b? [id:1177 order:6]
- chuẩn bị 3 option để ổng chọn

# tại sao nên ngồi kế b khi làm UI? [id:1178 order:7]
live coding làm task UI cho tiện

<!--# đặc điểm của b? [id:1179 order:8]
- ghét chỉnh sửa lặt vặt
- b đưa ra ý tưởng, requirement chung chung, dev phải tự demo output
- dev ít reschedule -->

<!--# thế nào là làm task chuyên nghiệp? [id:1180 order:9]
- no side effect
- deploy ít
- hỏi ngớ ngẩn
- demo output nếu cần
- chỉ ra requirement issue
- làm task đúng hạn
- info realtime và đầy đủ -->

<!--# quy tắc làm task? [id:1181 order:10]
- demo output nếu requirement chưa rõ ràng
- -->

<!--# quy tắc làm việc [id:1182 order:11]
tự document để nắm hết được mọi logic, realtime -->

# làm tốt ở Vanthiel để làm gì? [id:1183 order:12]
