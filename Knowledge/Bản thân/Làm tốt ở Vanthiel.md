...
<!--# Thế nào là làm task tốt? [id:724 order:0]
...
<!--# mình cần comment những gì? [id:725 order:1]
- progress
- lí do task làm lâu
- các feature, logic liên quan đến task -->

# lưu ý khi update thông tin trong task? [id:726 order:2]
- thông tin phải realtime

# Khi nào thì nên hỏi b? [id:722 order:3]
- khi đó là UI k đơn giản

<!--# b muốn gì? [id:719 order:4]
...
# lưu ý gì khi hỏi b? [id:727 order:5]
- chuẩn bị 3 option để ổng chọn

# tại sao nên ngồi kế b khi làm UI? [id:728 order:6]
live coding làm task UI cho tiện

<!--# đặc điểm của b? [id:729 order:7]
- ghét chỉnh sửa lặt vặt
- b đưa ra ý tưởng, requirement chung chung, dev phải tự demo output
- dev ít reschedule -->

<!--# thế nào là làm task chuyên nghiệp? [id:730 order:8]
- no side effect
- deploy ít
- hỏi ngớ ngẩn
- demo output nếu cần
...
<!--# quy tắc làm task? [id:731 order:9]
- demo output nếu requirement chưa rõ ràng
- -->

<!--# quy tắc làm việc [id:732 order:10]
tự document để nắm hết được mọi logic, realtime -->

# làm tốt ở Vanthiel để làm gì? [id:733 order:11]
