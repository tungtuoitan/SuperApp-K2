...
# Vì sao mình cần chữa bệnh? [id:744 order:1]
- vì sức khoẻ là ưu tiên hàng đầu

# Vì sao 2026 phải làm trùm dev? [id:745 order:2]
nó cho mình cảm hứng và tự tin

# Thế nào là trùm dev? [id:746 order:3]
- Refactor SuperApp
- 100 Scenario-based Question

# Mục tiêu 2026 là gì? [id:747 order:4]
Trùm dev
5 thói quen
chữa bệnh

# Vì sao mình cần thói quen? [id:748 order:5]
vì thói quen là bước đầu của kỉ luật

# Thói quen ưu tiên nhất nên là gì? [id:749 order:6]
