...
<!--# Thế nào là làm task tốt? [id:1685 order:1]
...
<!--# mình cần comment những gì? [id:1686 order:2]
- progress
- lí do task làm lâu
- các feature, logic liên quan đến task -->

# lưu ý khi update thông tin trong task? [id:1687 order:3]
- thông tin phải realtime

# Khi nào thì nên hỏi b? [id:1688 order:4]
- khi đó là UI k đơn giản

<!--# b muốn gì? [id:1689 order:5]
...
# lưu ý gì khi hỏi b? [id:1690 order:6]
- chuẩn bị 3 option để ổng chọn

# tại sao nên ngồi kế b khi làm UI? [id:1691 order:7]
live coding làm task UI cho tiện

<!--# đặc điểm của b? [id:1692 order:8]
- ghét chỉnh sửa lặt vặt
- b đưa ra ý tưởng, requirement chung chung, dev phải tự demo output
- dev ít reschedule -->

<!--# thế nào là làm task chuyên nghiệp? [id:1693 order:9]
- no side effect
- deploy ít
- hỏi ngớ ngẩn
- demo output nếu cần
...
<!--# quy tắc làm task? [id:1694 order:10]
- demo output nếu requirement chưa rõ ràng
- -->

<!--# quy tắc làm việc [id:1695 order:11]
tự document để nắm hết được mọi logic, realtime -->

# làm tốt ở Vanthiel để làm gì? [id:1696 order:12]
