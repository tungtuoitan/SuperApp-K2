...
# imperative là gì? [id:2925 order:1]
- code nhiều dòng, mỗi dòng là 1 hành động nhỏ

# Declarative là gì? [id:2926 order:2]
là code 1 dòng mô tả kết quả

# Liên hệ giữa declarative và imperative? [id:2927 order:3]
declarative api là imperative code được đóng gói lại

# React được thiết kế theo kiểu gì? [id:2928 order:4]
vì sao? [id:238 order:22]
theo kiểu declarative
vì dev chỉ cần mô tả UI, React sẽ lo việc cập nhật DOM

# React có imperative không? [id:2929 order:5]
ví dụ? [id:239 order:23]
có
ví dụ: useEffect, useRef

# declarative và imperative, cái nào phổ biến hơn? [id:2930 order:6]
...
# ví dụ declarative và imperative? [id:2931 order:7]
declarative: React, SQL
imperative: useEffect, DOM api,

# vì sao useEffect là imperative? [id:2932 order:8]
