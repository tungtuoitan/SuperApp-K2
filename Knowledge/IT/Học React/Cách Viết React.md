...
# khi nào thì nên tạo  component riêng cho List? [id:607 order:13]
...
# Interceptor là gì? [id:608 order:27]
...
# tradeoff của caching là gì? [id:225 order:35]
dữ liệu có thể bị cũ

# code bị nest thì sao? [id:232 order:36]
