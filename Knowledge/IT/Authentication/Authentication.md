...
# Uỷ quyền và trao quyền có phải là 1 không? [id:1699 order:3]
có, chúng là 1.

# Phân biệt Authentication và authorization? [id:1700 order:4]
- authentication là xác thực, còn authorization là trao quyền
- E trước O
- xác thực xong thì mới trao quyền

# Token-based Authentication là gì? [id:1701 order:5]
- là xác thực dựa trên Token

# Authentication là gì? [id:1702 order:6]
