...
# private key và public key dùng để làm gì? [id:1276 order:1]
- mã hóa dữ liệu để bảo mật
- kí token

# ví dụ pattern ngoài đời thật tương tự private key, public key ? [id:1277 order:2]
Private key = con dấu thật của công ty
Public key = mẫu dấu công khai cho mọi người xem

# cách dùng private key, public key để mã hóa? [id:1278 order:3]
