...
# Uỷ quyền và trao quyền có phải là 1 không? [id:861 order:3]
có, chúng là 1.

# Phân biệt Authentication và authorization? [id:862 order:4]
- authentication là xác thực, còn authorization là trao quyền
- E trước O
- xác thực xong thì mới trao quyền

# Token-based Authentication là gì? [id:857 order:11]
- là xác thực dựa trên Token

# Authentication là gì? [id:858 order:14]
