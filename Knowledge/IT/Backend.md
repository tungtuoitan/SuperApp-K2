...
# "tránh coupling" là gì? [id:802 order:2]
là tránh việc A phụ thuộc CỨNG vào B

# tight coupling là gì? [id:803 order:3]
là A phụ thuộc  quá chặt vào B

# tầng cross-cutting thường chứa gì? [id:804 order:4]
...
# .NET xác định môi trường dựa vào đâu? [id:807 order:7]
dựa vào biến môi trường: ASPNETCORE_ENVIROMENT

# file appsettings nào được dùng ,đc quyết định bởi cái gì? [id:808 order:8]
được quyết định bởi môi trường

# so sánh file app.config và appsettings.json? [id:809 order:9]
...
# nên dùng app.config hay appsettings? vì sao? [id:810 order:10]
